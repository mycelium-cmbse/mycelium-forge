// ------------------------------------------------------------------------------------------------
// <copyright file="Account.cs" company="Starion Group S.A.">
//
...
namespace Mycelium.Forge.Common
{
    ...
    public partial class Account : IAccount
    {
        ...
        [Implements(implementation: "IAccount.ApiKey")]
        public List<Guid> ApiKey { get; set; } = [];
        ...
        [Implements(implementation: "IAccount.AvatarBlobReference")]
        public string AvatarBlobReference { get; set; }
        ...
        [Implements(implementation: "IAccount.OwnedOrganizationInvitation")]
        public List<Guid> OwnedOrganizationInvitation { get; set; } = [];
        ...
        [Implements(implementation: "IAccount.OwnedPackageInvitation")]
        public Guid OwnedPackageInvitation { get; set; }
        ...
        [Implements(implementation: "IAccount.Owner")]
