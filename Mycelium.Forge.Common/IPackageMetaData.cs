...
namespace Mycelium.Forge.Common
{
    ...
    /// <summary>
    /// Partial interface extending <see cref="IPackageMetaData" /> with metadata provenance, model element projections,
    /// dependencies, and quality checks.
    /// </summary>
    /// <remarks>
    /// This partial interface is temporary and will be removed once the domain metamodel is updated to include metadata
