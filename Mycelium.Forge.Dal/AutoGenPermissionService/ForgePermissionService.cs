...
namespace Mycelium.Forge.Dal.AutoGenPermissionService
{
    ...
    public partial class ForgePermissionService : PermissionServiceBase<IForge>, IForgePermissionService
    {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToCreateImplementation(IUserContext userContext, IForge toCreate, NpgsqlTransaction transaction = null)
        {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToReadImplementation(IUserContext userContext, IForge thing, NpgsqlTransaction transaction = null)
        {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToUpdateImplementation(IUserContext userContext, IForge existingThing, IForge updatedThing, NpgsqlTransaction transaction = null)
        {
            return Task.FromResult(PermissionGuard.GuardPermission(userContext, PermissionKind.ConfigurePlatformDefaults));
        }
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToDeleteImplementation(IUserContext userContext, IForge thing, NpgsqlTransaction transaction = null)
        {
            return Task.FromResult(PermissionGuard.GuardPermission(userContext, PermissionKind.ConfigurePlatformDefaults));
        }
    }
