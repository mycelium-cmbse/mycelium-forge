...
namespace Mycelium.Forge.Dal.AutoGenPermissionService
{
    ...
    public partial class PackageVersionPermissionService : PermissionServiceBase<IPackageVersion>, IPackageVersionPermissionService
    {
        ...
        protected override Task<Result> IsAllowedToCreateImplementation(IUserContext userContext, IPackageVersion toCreate)
        {
        ...
        protected override Task<Result> IsAllowedToReadImplementation(IUserContext userContext, IPackageVersion thing)
        {
        ...
        {
            return Task.FromResult(PermissionGuard.GuardPermission(userContext, PermissionKind.ErasePackageVersion));
        }
    }
}
