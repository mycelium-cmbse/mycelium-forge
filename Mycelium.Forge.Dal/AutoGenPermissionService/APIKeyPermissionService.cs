...
namespace Mycelium.Forge.Dal.AutoGenPermissionService
{
    ...
    public partial class APIKeyPermissionService : PermissionServiceBase<IAPIKey>, IAPIKeyPermissionService
    {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToCreateImplementation(IUserContext userContext, IAPIKey toCreate)
        {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToReadImplementation(IUserContext userContext, IAPIKey thing)
        {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToUpdateImplementation(IUserContext userContext, IAPIKey existingThing, IAPIKey updatedThing)
        {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToDeleteImplementation(IUserContext userContext, IAPIKey thing)
        {
            if (userContext.AccountId.HasValue && thing.Owner == userContext.AccountId.Value)
            {
                return Task.FromResult<ErrorOr<Success>>(Result.Success);
