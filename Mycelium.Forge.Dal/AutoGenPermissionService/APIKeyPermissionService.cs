// ------------------------------------------------------------------------------------------------
// <copyright file="APIKeyPermissionService.cs" company="Starion Group S.A.">
//
...
namespace Mycelium.Forge.Dal.AutoGenPermissionService
{
    ...
    /// <summary>
    /// Default permission service for <see cref="IAPIKey"/>.
    /// </summary>
    [GeneratedCode("Mycelium.Forge.Generator", "1.0.0")]
    public partial class APIKeyPermissionService : PermissionServiceBase<IAPIKey>, IAPIKeyPermissionService
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APIKeyPermissionService"/> class.
        /// </summary>
        public APIKeyPermissionService()
        {
        }
        ...
        protected override Task<Result> IsAllowedToCreateImplementation(IUserContext userContext, IAPIKey toCreate)
        {
            return Task.FromResult(PermissionGuard.GuardPermission(userContext, PermissionKind.IssueApiKey));
        }
        ...
        protected override Task<Result> IsAllowedToReadImplementation(IUserContext userContext, IAPIKey thing)
        {
            ...
            return Task.FromResult(PermissionGuard.GuardPermission(userContext, PermissionKind.ListOwnApiKeys));
        }
        ...
        protected override Task<Result> IsAllowedToUpdateImplementation(IUserContext userContext, IAPIKey existingThing, IAPIKey updatedThing)
        {
            ...
            return Task.FromResult(PermissionGuard.GuardPermission(userContext, PermissionKind.RevokeOwnApiKey));
        }
