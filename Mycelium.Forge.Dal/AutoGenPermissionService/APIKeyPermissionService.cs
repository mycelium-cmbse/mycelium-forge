...
namespace Mycelium.Forge.Dal.AutoGenPermissionService
{
    ...
    public partial class APIKeyPermissionService : PermissionServiceBase<IAPIKey>, IAPIKeyPermissionService
    {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToCreateImplementation(IUserContext userContext, IAPIKey toCreate, NpgsqlTransaction transaction = null)
        {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToReadImplementation(IUserContext userContext, IAPIKey thing, NpgsqlTransaction transaction = null)
        {
            ...
            return Task.FromResult(PermissionGuard.GuardPermission(userContext, PermissionKind.RevokeAnyApiKey));
        }
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToUpdateImplementation(IUserContext userContext, IAPIKey existingThing, IAPIKey updatedThing, NpgsqlTransaction transaction = null)
        {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToDeleteImplementation(IUserContext userContext, IAPIKey thing, NpgsqlTransaction transaction = null)
        {
            if (userContext.AccountId.HasValue && thing.Owner == userContext.AccountId.Value)
            {
                return Task.FromResult<ErrorOr<Success>>(Result.Success);
