...
namespace Mycelium.Forge.Dal.AutoGenPermissionService
{
    ...
    public partial class AccountPermissionService : PermissionServiceBase<IAccount>, IAccountPermissionService
    {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToCreateImplementation(IUserContext userContext, IAccount toCreate)
        {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToReadImplementation(IUserContext userContext, IAccount thing)
        {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToUpdateImplementation(IUserContext userContext, IAccount existingThing, IAccount updatedThing)
        {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToDeleteImplementation(IUserContext userContext, IAccount thing)
        {
            if (userContext.AccountId.HasValue && thing.Id == userContext.AccountId.Value)
            {
                return Task.FromResult<ErrorOr<Success>>(Result.Success);
