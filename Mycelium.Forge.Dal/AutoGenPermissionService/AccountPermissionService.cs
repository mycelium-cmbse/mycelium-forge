...
namespace Mycelium.Forge.Dal.AutoGenPermissionService
{
    ...
    public partial class AccountPermissionService : PermissionServiceBase<IAccount>, IAccountPermissionService
    {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToCreateImplementation(IUserContext userContext, IAccount toCreate, NpgsqlTransaction transaction = null)
        {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToReadImplementation(IUserContext userContext, IAccount thing, NpgsqlTransaction transaction = null)
        {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToUpdateImplementation(IUserContext userContext, IAccount existingThing, IAccount updatedThing, NpgsqlTransaction transaction = null)
        {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToDeleteImplementation(IUserContext userContext, IAccount thing, NpgsqlTransaction transaction = null)
        {
            if (userContext.AccountId.HasValue && thing.Id == userContext.AccountId.Value)
            {
                return Task.FromResult<ErrorOr<Success>>(Result.Success);
