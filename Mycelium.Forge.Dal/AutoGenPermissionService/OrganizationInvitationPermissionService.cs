...
namespace Mycelium.Forge.Dal.AutoGenPermissionService
{
    ...
    public partial class OrganizationInvitationPermissionService : PermissionServiceBase<IOrganizationInvitation>, IOrganizationInvitationPermissionService
    {
        ...
        protected override Task<Result> IsAllowedToCreateImplementation(IUserContext userContext, IOrganizationInvitation toCreate)
        {
            return Task.FromResult(PermissionGuard.GuardPermission(userContext, PermissionKind.InviteOrganizationMembers));
        }
        ...
        protected override Task<Result> IsAllowedToReadImplementation(IUserContext userContext, IOrganizationInvitation thing)
        {
            ...
            return Task.FromResult(PermissionGuard.GuardPermission(userContext, PermissionKind.ViewOrganizationMemberList));
        }
        ...
        {
            return Task.FromResult(PermissionGuard.GuardPermission(userContext, PermissionKind.RemoveOrganizationMembers));
        }
    }
}
