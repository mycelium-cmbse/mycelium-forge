...
namespace Mycelium.Forge.Dal.AutoGenPermissionService
{
    ...
    public partial class PackageTypePermissionService : PermissionServiceBase<IPackageType>, IPackageTypePermissionService
    {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToCreateImplementation(IUserContext userContext, IPackageType toCreate, NpgsqlTransaction transaction = null)
        {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToReadImplementation(IUserContext userContext, IPackageType thing, NpgsqlTransaction transaction = null)
        {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToUpdateImplementation(IUserContext userContext, IPackageType existingThing, IPackageType updatedThing, NpgsqlTransaction transaction = null)
        {
            return Task.FromResult(PermissionGuard.GuardPermission(userContext, PermissionKind.ConfigurePlatformDefaults));
        }
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToDeleteImplementation(IUserContext userContext, IPackageType thing, NpgsqlTransaction transaction = null)
        {
            return Task.FromResult(PermissionGuard.GuardPermission(userContext, PermissionKind.ConfigurePlatformDefaults));
        }
    }
