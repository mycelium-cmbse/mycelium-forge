// ------------------------------------------------------------------------------------------------
// <copyright file="PackageTypePermissionService.cs" company="Starion Group S.A.">
//
...
namespace Mycelium.Forge.Dal.AutoGenPermissionService
{
    ...
    /// <summary>
    /// Default permission service for <see cref="IPackageType"/>.
    /// </summary>
    [GeneratedCode("Mycelium.Forge.Generator", "1.0.0")]
    public partial class PackageTypePermissionService : PermissionServiceBase<IPackageType>, IPackageTypePermissionService
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PackageTypePermissionService"/> class.
        /// </summary>
        public PackageTypePermissionService()
        {
        }
        ...
        protected override Task<Result> IsAllowedToCreateImplementation(IUserContext userContext, IPackageType toCreate)
        {
        ...
        protected override Task<Result> IsAllowedToReadImplementation(IUserContext userContext, IPackageType thing)
        {
            return Task.FromResult(PermissionGuard.GuardPermission(userContext, PermissionKind.ReadPackageType));
        }
        ...
        protected override Task<Result> IsAllowedToUpdateImplementation(IUserContext userContext, IPackageType existingThing, IPackageType updatedThing)
        {
            return Task.FromResult(PermissionGuard.GuardPermission(userContext, PermissionKind.ConfigurePlatformDefaults));
        }
