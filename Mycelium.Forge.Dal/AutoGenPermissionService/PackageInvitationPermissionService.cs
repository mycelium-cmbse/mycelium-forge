...
namespace Mycelium.Forge.Dal.AutoGenPermissionService
{
    ...
    public partial class PackageInvitationPermissionService : PermissionServiceBase<IPackageInvitation>, IPackageInvitationPermissionService
    {
        ...
        protected override Task<Result> IsAllowedToCreateImplementation(IUserContext userContext, IPackageInvitation toCreate)
        {
            return Task.FromResult(PermissionGuard.GuardPermission(userContext, PermissionKind.ManagePackageTeam));
        }
        ...
        protected override Task<Result> IsAllowedToReadImplementation(IUserContext userContext, IPackageInvitation thing)
        {
