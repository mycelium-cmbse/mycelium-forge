...
namespace Mycelium.Forge.Dal.AutoGenPermissionService
{
    ...
    public partial class ProfileLinkPermissionService : PermissionServiceBase<IProfileLink>, IProfileLinkPermissionService
    {
        ...
        protected override Task<Result> IsAllowedToReadImplementation(IUserContext userContext, IProfileLink thing)
        {
        ...
        protected override Task<Result> IsAllowedToUpdateImplementation(IUserContext userContext, IProfileLink existingThing, IProfileLink updatedThing)
        {
