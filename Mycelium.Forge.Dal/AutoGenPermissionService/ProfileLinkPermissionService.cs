...
namespace Mycelium.Forge.Dal.AutoGenPermissionService
{
    ...
    public partial class ProfileLinkPermissionService : PermissionServiceBase<IProfileLink>, IProfileLinkPermissionService
    {
        ...
        protected override async Task<ErrorOr<Success>> IsAllowedToCreateImplementation(IUserContext userContext, IProfileLink toCreate)
        {
        ...
        protected override async Task<ErrorOr<Success>> IsAllowedToReadImplementation(IUserContext userContext, IProfileLink thing)
        {
        ...
        protected override async Task<ErrorOr<Success>> IsAllowedToUpdateImplementation(IUserContext userContext, IProfileLink existingThing, IProfileLink updatedThing)
        {
        ...
        protected override async Task<ErrorOr<Success>> IsAllowedToDeleteImplementation(IUserContext userContext, IProfileLink thing)
        {
