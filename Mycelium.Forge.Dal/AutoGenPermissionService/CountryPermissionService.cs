// ------------------------------------------------------------------------------------------------
// <copyright file="CountryPermissionService.cs" company="Starion Group S.A.">
//
...
namespace Mycelium.Forge.Dal.AutoGenPermissionService
{
    ...
    /// <summary>
    /// Default permission service for <see cref="ICountry"/>.
    /// </summary>
    [GeneratedCode("Mycelium.Forge.Generator", "1.0.0")]
    public partial class CountryPermissionService : PermissionServiceBase<ICountry>, ICountryPermissionService
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CountryPermissionService"/> class.
        /// </summary>
        public CountryPermissionService()
        {
        }
        ...
        protected override Task<Result> IsAllowedToCreateImplementation(IUserContext userContext, ICountry toCreate)
        {
        ...
        protected override Task<Result> IsAllowedToUpdateImplementation(IUserContext userContext, ICountry existingThing, ICountry updatedThing)
        {
            return Task.FromResult(PermissionGuard.GuardPermission(userContext, PermissionKind.ConfigurePlatformDefaults));
        }
