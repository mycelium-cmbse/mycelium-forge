...
namespace Mycelium.Forge.Dal.AutoGenPermissionService
{
    ...
    public partial class CountryPermissionService : PermissionServiceBase<ICountry>, ICountryPermissionService
    {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToCreateImplementation(IUserContext userContext, ICountry toCreate, NpgsqlTransaction transaction = null)
        {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToReadImplementation(IUserContext userContext, ICountry thing, NpgsqlTransaction transaction = null)
        {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToUpdateImplementation(IUserContext userContext, ICountry existingThing, ICountry updatedThing, NpgsqlTransaction transaction = null)
        {
            return Task.FromResult(PermissionGuard.GuardPermission(userContext, PermissionKind.ConfigurePlatformDefaults));
        }
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToDeleteImplementation(IUserContext userContext, ICountry thing, NpgsqlTransaction transaction = null)
        {
            return Task.FromResult(PermissionGuard.GuardPermission(userContext, PermissionKind.ConfigurePlatformDefaults));
        }
    }
