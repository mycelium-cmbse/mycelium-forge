...
namespace Mycelium.Forge.Dal.AutoGenPermissionService
{
    ...
    public partial class CountryPermissionService : PermissionServiceBase<ICountry>, ICountryPermissionService
    {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToCreateImplementation(IUserContext userContext, ICountry toCreate)
        {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToReadImplementation(IUserContext userContext, ICountry thing)
        {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToUpdateImplementation(IUserContext userContext, ICountry existingThing, ICountry updatedThing)
        {
            return Task.FromResult(PermissionGuard.GuardPermission(userContext, PermissionKind.ConfigurePlatformDefaults));
        }
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToDeleteImplementation(IUserContext userContext, ICountry thing)
        {
            return Task.FromResult(PermissionGuard.GuardPermission(userContext, PermissionKind.ConfigurePlatformDefaults));
        }
    }
