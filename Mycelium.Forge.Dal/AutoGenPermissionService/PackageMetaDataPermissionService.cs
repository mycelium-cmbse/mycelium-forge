...
namespace Mycelium.Forge.Dal.AutoGenPermissionService
{
    ...
    public partial class PackageMetaDataPermissionService : PermissionServiceBase<IPackageMetaData>, IPackageMetaDataPermissionService
    {
        ...
        protected override async Task<ErrorOr<Success>> IsAllowedToCreateImplementation(IUserContext userContext, IPackageMetaData toCreate, NpgsqlTransaction transaction = null)
        {
            ...
            {
                return await this.packageVersionPermissionService.IsAllowedToUpdate(userContext, parentResult.Value[0], parentResult.Value[0], transaction);
            }
        ...
        protected override async Task<ErrorOr<Success>> IsAllowedToDeleteImplementation(IUserContext userContext, IPackageMetaData thing, NpgsqlTransaction transaction = null)
        {
            ...
            if (!parentResult.IsError && parentResult.Value.Count > 0)
            {
                return await this.packageVersionPermissionService.IsAllowedToDelete(userContext, parentResult.Value[0], transaction);
            }
