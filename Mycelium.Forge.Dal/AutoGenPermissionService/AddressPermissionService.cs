...
namespace Mycelium.Forge.Dal.AutoGenPermissionService
{
    ...
    public partial class AddressPermissionService : PermissionServiceBase<IAddress>, IAddressPermissionService
    {
        ...
        protected override async Task<ErrorOr<Success>> IsAllowedToCreateImplementation(IUserContext userContext, IAddress toCreate, NpgsqlTransaction transaction = null)
        {
            return await ScopeItemPermissionHelper.IsAllowedToManageScopeItem(userContext, toCreate.Owner, this.organizationService, "address", PermissionKind.ManageOwnProfile, PermissionKind.ManageOrganizations, PermissionKind.ManageOrganizationSettings, transaction);
        }
        ...
        protected override async Task<ErrorOr<Success>> IsAllowedToReadImplementation(IUserContext userContext, IAddress thing, NpgsqlTransaction transaction = null)
        {
        ...
        protected override async Task<ErrorOr<Success>> IsAllowedToUpdateImplementation(IUserContext userContext, IAddress existingThing, IAddress updatedThing, NpgsqlTransaction transaction = null)
        {
            return await ScopeItemPermissionHelper.IsAllowedToManageScopeItem(userContext, existingThing.Owner, this.organizationService, "address", PermissionKind.ManageOwnProfile, PermissionKind.ManageOrganizations, PermissionKind.ManageOrganizationSettings, transaction);
        }
        ...
        protected override async Task<ErrorOr<Success>> IsAllowedToDeleteImplementation(IUserContext userContext, IAddress thing, NpgsqlTransaction transaction = null)
        {
            return await ScopeItemPermissionHelper.IsAllowedToManageScopeItem(userContext, thing.Owner, this.organizationService, "address", PermissionKind.ManageOwnProfile, PermissionKind.ManageOrganizations, PermissionKind.ManageOrganizationSettings, transaction);
        }
    }
}
