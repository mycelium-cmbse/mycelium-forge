...
namespace Mycelium.Forge.Dal.AutoGenPermissionService
{
    ...
    public partial class OrganizationPermissionService : PermissionServiceBase<IOrganization>, IOrganizationPermissionService
    {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToCreateImplementation(IUserContext userContext, IOrganization toCreate)
        {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToReadImplementation(IUserContext userContext, IOrganization thing)
        {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToUpdateImplementation(IUserContext userContext, IOrganization existingThing, IOrganization updatedThing)
        {
        ...
        protected override Task<ErrorOr<Success>> IsAllowedToDeleteImplementation(IUserContext userContext, IOrganization thing)
        {
