...
namespace Mycelium.Forge.Dal.AutoGenDtoValidator
{
    ...
    public sealed partial class AddressValidator : DtoValidatorBase<IAddress>
    {
        ...
        /// </returns>
        public override async Task<ErrorOr<Success>> ValidateDto(IAddress dto)
        {
        ...
        /// A new <see cref="ErrorOr{Success}"/> indicating whether the validation was successful.
        /// </returns>
        public override async Task<ErrorOr<Success>> ValidateFields(IAddress dto, params Expression<Func<IAddress, object>>[] fields)
        {
