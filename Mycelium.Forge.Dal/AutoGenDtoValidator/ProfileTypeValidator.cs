// ------------------------------------------------------------------------------------------------
// <copyright file="ProfileTypeValidator.cs" company="Starion Group S.A.">
//
...
namespace Mycelium.Forge.Dal.AutoGenDtoValidator
{
    ...
    /// <summary>
    /// DTO validator class for the <see cref="ProfileType"/> class.
    /// </summary>
    [GeneratedCode("Mycelium.Forge.Generator", "1.0.0")]
    public sealed partial class ProfileTypeValidator : DtoValidatorBase<IProfileType>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProfileTypeValidator"/> class.
        /// </summary>
        public ProfileTypeValidator()
        {
            this.RuleFor(x => x.CreatedAt).NotEmpty();
            this.RuleFor(x => x.Id).NotNull();
            this.RuleFor(x => x.LogoBlobReference).NotEmpty();
        ...
        /// </summary>
        /// <param name="dto">The <see cref="IProfileType"/> to validate.</param>
        /// <returns>
        /// A new <see cref="ErrorOr{Success}"/> indicating whether the validation was successful.
        /// </returns>
        public override async Task<ErrorOr<Success>> ValidateDto(IProfileType dto)
        {
        ...
        /// A new <see cref="ErrorOr{Success}"/> indicating whether the validation was successful.
        /// </returns>
        public override async Task<ErrorOr<Success>> ValidateFields(IProfileType dto, params Expression<Func<IProfileType, object>>[] fields)
        {
