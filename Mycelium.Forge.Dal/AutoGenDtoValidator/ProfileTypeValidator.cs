...
namespace Mycelium.Forge.Dal.AutoGenDtoValidator
{
    ...
    public sealed partial class ProfileTypeValidator : DtoValidatorBase<IProfileType>
    {
        ...
        /// </returns>
        public override async Task<Result> ValidateDto(IProfileType dto)
        {
        ...
        /// A new <see cref="Result"/> indicating whether the validation was successful.
        /// </returns>
        public override async Task<Result> ValidateFields(IProfileType dto, params Expression<Func<IProfileType, object>>[] fields)
        {
