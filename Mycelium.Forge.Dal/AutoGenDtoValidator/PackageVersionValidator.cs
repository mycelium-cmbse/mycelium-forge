...
namespace Mycelium.Forge.Dal.AutoGenDtoValidator
{
    ...
    public sealed partial class PackageVersionValidator : DtoValidatorBase<IPackageVersion>
    {
        /// <summary>
