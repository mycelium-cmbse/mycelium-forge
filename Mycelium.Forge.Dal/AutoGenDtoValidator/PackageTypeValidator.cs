...
namespace Mycelium.Forge.Dal.AutoGenDtoValidator
{
    ...
    public sealed partial class PackageTypeValidator : DtoValidatorBase<IPackageType>
    {
        ...
        /// </returns>
        public override async Task<Result> ValidateDto(IPackageType dto)
        {
        ...
        /// A new <see cref="Result"/> indicating whether the validation was successful.
        /// </returns>
        public override async Task<Result> ValidateFields(IPackageType dto, params Expression<Func<IPackageType, object>>[] fields)
        {
