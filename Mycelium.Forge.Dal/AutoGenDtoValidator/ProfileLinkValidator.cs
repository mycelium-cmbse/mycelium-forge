...
namespace Mycelium.Forge.Dal.AutoGenDtoValidator
{
    ...
    public sealed partial class ProfileLinkValidator : DtoValidatorBase<IProfileLink>
    {
        ...
        /// </returns>
        public override async Task<Result> ValidateDto(IProfileLink dto)
        {
        ...
        /// A new <see cref="Result"/> indicating whether the validation was successful.
        /// </returns>
        public override async Task<Result> ValidateFields(IProfileLink dto, params Expression<Func<IProfileLink, object>>[] fields)
        {
