// ------------------------------------------------------------------------------------------------
// <copyright file="ProfileLinkValidator.cs" company="Starion Group S.A.">
//
...
namespace Mycelium.Forge.Dal.AutoGenDtoValidator
{
    ...
    /// <summary>
    /// DTO validator class for the <see cref="ProfileLink"/> class.
    /// </summary>
    [GeneratedCode("Mycelium.Forge.Generator", "1.0.0")]
    public sealed partial class ProfileLinkValidator : DtoValidatorBase<IProfileLink>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProfileLinkValidator"/> class.
        /// </summary>
        public ProfileLinkValidator()
        {
            ...
            this.RuleFor(x => x.ProfileType).NotEmpty();
            this.RuleFor(x => x.Uri).NotEmpty();
        ...
        /// </summary>
        /// <param name="dto">The <see cref="IProfileLink"/> to validate.</param>
        /// <returns>
        /// A new <see cref="ErrorOr{Success}"/> indicating whether the validation was successful.
        /// </returns>
        public override async Task<ErrorOr<Success>> ValidateDto(IProfileLink dto)
        {
        ...
        /// A new <see cref="ErrorOr{Success}"/> indicating whether the validation was successful.
        /// </returns>
        public override async Task<ErrorOr<Success>> ValidateFields(IProfileLink dto, params Expression<Func<IProfileLink, object>>[] fields)
        {
