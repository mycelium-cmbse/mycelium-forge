...
namespace Mycelium.Forge.Dal.AutoGenDtoValidator
{
    ...
    public sealed partial class PackageValidator : DtoValidatorBase<IPackage>
    {
        ...
        /// </returns>
        public override async Task<Result> ValidateDto(IPackage dto)
        {
        ...
        /// A new <see cref="Result"/> indicating whether the validation was successful.
        /// </returns>
        public override async Task<Result> ValidateFields(IPackage dto, params Expression<Func<IPackage, object>>[] fields)
        {
