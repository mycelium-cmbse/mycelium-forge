...
namespace Mycelium.Forge.Dal.AutoGenDtoValidator
{
    ...
    public sealed partial class CountryValidator : DtoValidatorBase<ICountry>
    {
        ...
        /// </returns>
        public override async Task<Result> ValidateDto(ICountry dto)
        {
        ...
        /// A new <see cref="Result"/> indicating whether the validation was successful.
        /// </returns>
        public override async Task<Result> ValidateFields(ICountry dto, params Expression<Func<ICountry, object>>[] fields)
        {
