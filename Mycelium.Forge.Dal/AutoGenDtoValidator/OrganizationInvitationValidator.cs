...
namespace Mycelium.Forge.Dal.AutoGenDtoValidator
{
    ...
    public sealed partial class OrganizationInvitationValidator : DtoValidatorBase<IOrganizationInvitation>
    {
        ...
        /// </returns>
        public override async Task<Result> ValidateDto(IOrganizationInvitation dto)
        {
        ...
        /// A new <see cref="Result"/> indicating whether the validation was successful.
        /// </returns>
        public override async Task<Result> ValidateFields(IOrganizationInvitation dto, params Expression<Func<IOrganizationInvitation, object>>[] fields)
        {
