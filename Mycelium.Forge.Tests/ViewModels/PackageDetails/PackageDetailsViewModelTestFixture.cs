    ...
    public class PackageDetailsViewModelTestFixture
    {
        ...
        public async Task VerifyInitializeViewModel()
        {
            ...
            this.packageServiceMock
                .Setup(x => x.ReadByCoordinateAsync(this.userContext, "starion", "ecss-mm-pwr", It.IsAny<CancellationToken>()))
                .ReturnsAsync(ErrorOrFactory.From<IPackage>(package));

            this.scopeServiceMock
                .Setup(x => x.ReadAsync(this.userContext, It.IsAny<CancellationToken>(), It.IsAny<Guid[]>()))
                .ReturnsAsync(ErrorOrFactory.From(ImmutableList.Create<IScope>(org)));
            ...
            this.packageServiceMock
                .Setup(x => x.ReadByCoordinateAsync(this.userContext, "other-org", "nonexistent", It.IsAny<CancellationToken>()))
