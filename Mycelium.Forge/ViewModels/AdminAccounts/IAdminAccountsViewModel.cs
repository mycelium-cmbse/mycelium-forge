...
namespace Mycelium.Forge.ViewModels.AdminAccounts
{
    ...
    public interface IAdminAccountsViewModel
    {
        ...
        void InitializeViewModel(string searchQuery = "", string statusFilter = AdminAccountsViewModel.AllStatusFilter, VerificationFilterOption verificationFilter = VerificationFilterOption.All);
        ...
        void ApplyFilters(string searchQuery, string statusFilter, VerificationFilterOption verificationFilter);
