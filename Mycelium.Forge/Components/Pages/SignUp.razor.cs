...
namespace Mycelium.Forge.Components.Pages
{
    ...
    public partial class SignUp : ComponentBase
    {
        ...
        {
            this.ViewModel.Registration.Username = username ?? string.Empty;
        }
        ...
        {
            this.ViewModel.Registration.Email = email ?? string.Empty;
        }
        ...
        {
            this.ViewModel.Registration.Password = password ?? string.Empty;
        }
