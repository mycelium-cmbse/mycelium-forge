...
namespace Mycelium.Forge.Data
{
    ...
    public class DatabaseSeeder : IDatabaseSeeder
    {
        ...
        /// <param name="databaseSource">The database connection source.</param>
        ...
        private async Task<bool> ResetDatabaseAsync(CancellationToken cancellationToken)
        {
            ...
            await using (var connection = await this.databaseSource.OpenNewConnectionAsync(cancellationToken))
            {
            ...
            if (!Migrator.Run(connectionString))
            {
